...
var AutoFill = function( oDT, oConfig )
{
	...
	this.s = {
		...
		/**
		 * @namespace Data config.cache for information that we need for scrolling the screen when we near
		 *   the edges
		 */
		"screen": {
			"interval": null,
		...
		/**
		 * @namespace Data config.cache for the position of the DataTables scrolling element (when scrolling
		 *   is enabled)
		 */
		"scroller": {
			"top": 0,
...
AutoFill.prototype = {
	...
	"_fnFillerDragStart": function (e)
	{
		...
		/* Scrolling information config.cache */
