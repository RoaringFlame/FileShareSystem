...
FixedHeader.prototype = {
	 ...
	 * Purpose:  Check the config.cache and update config.cache and value if needed
	 * Returns:  -
	 * Inputs:   object:oCache - local config.cache object
	 *           string:sCache - config.cache property
